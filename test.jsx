        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[17%] max-md:ml-0 max-md:w-full">
            <div className="flex z-10 flex-col grow items-start mt-9 max-md:mt-10 max-md:-mr-1.5">
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/6a21ef593faad2065f267d915a32da27fca0e9a7fc382c54ddc8dc044c32f444?placeholderIfAbsent=true&apiKey=2abb0b1728de4d98902e239cea09e9d5"
