        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[17%] max-md:ml-0 max-md:w-full">
            <div className="flex z-10 flex-col grow items-start mt-9 max-md:mt-10 max-md:-mr-1.5">
              <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/2abb0b1728de4d98902e239cea09e9d5/8a2e60f3491c08a9675e129844ef4c0718b36894ba3ba7647e414ce38d26c6d6?apiKey=2abb0b1728de4d98902e239cea09e9d5&" alt="Illustration barre latérale" className="object-contain ml-3.5 w-full aspect-[0.64] max-md:ml-2.5" />
